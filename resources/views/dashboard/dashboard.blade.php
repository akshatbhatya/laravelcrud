    ...
    <div class="dashboard-container">
        ...
        <div class="main-content p-4">
            <div class="content-header d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex">
                    <button class="btn btn-primary me-2 rounded-pill shadow-sm" data-bs-toggle="modal"
                        data-bs-target="#addUserModal">
                        <i class="bi bi-person-plus me-1"></i> Add User
                    </button>
                    <button class="btn btn-success rounded-pill shadow-sm" data-bs-toggle="modal"
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-success rounded-circle ms-1"
                                                        onclick="openAssignDeptModal({{$user->id}}, '{{$user->name}}')"
                                                        title="Assign Department">
                                                        <i class="bi bi-building"></i>
                                                    </button>
                                                    <a class="btn btn-sm btn-outline-danger rounded-circle ms-1"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($departments as $department)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                $userCount = DB::table('department_assigns')
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-sm btn-outline-danger rounded-circle ms-1" href="#"
                                                        onclick="removeDepartment(`{{route('deletedepartment',$department->id)}}`)"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($assignments as $assignment)
                                        ...
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge bg-success rounded-pill">{{$assignment->department->departmentname ?? 'No Department' }}</span>
                                            </td>
                                            <td>{{date('Y-m-d', strtotime($assignment->created_at))}}</td>
                                            <td>
                                                <button class="btn btn-sm btn-outline-danger rounded-pill"
                                                    onclick="removeAssignment(`{{route('deleteassign',$assignment->id)}}`)">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <form id="updateUserForm" method="POST">
                    ...
                    <div class="modal-footer bg-light">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-success"><i class="bi bi-check-lg me-1"></i>Update
                            User</button>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <form method="POST" action="{{route("assigndepartment")}}">
                    ...
                    <div class="modal-footer bg-light">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-info text-white"><i class="bi bi-link me-1"></i>Assign
                            Department</button>
                    </div>
                </form>
            </div>
